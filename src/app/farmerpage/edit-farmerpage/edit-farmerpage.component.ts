...
@Component({
  selector: 'app-edit-farmerpage',
  templateUrl: './edit-farmerpage.component.html',
  styleUrls: ['./edit-farmerpage.component.scss']
})
export class EditFarmerpageComponent implements OnInit {
...
constructor(private storage: AngularFireStorage, private formBuilder: FormBuilder, private route: ActivatedRoute,
  public auth: AuthenticateService, private router: Router, private agro: FarmerpageService) {
}
