...
@Component({
  selector: 'app-show-agroshops',
  templateUrl: './show-agroshops.component.html',
  styleUrls: ['./show-agroshops.component.scss']
})
export class ShowAgroshopsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, public auth: AuthenticateService,
    public agro: AgroshopsService, private formBuilder: FormBuilder, private router: Router) {}
