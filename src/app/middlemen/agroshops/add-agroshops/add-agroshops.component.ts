...
@Component({
  selector: 'app-add-agroshops',
  templateUrl: './add-agroshops.component.html',
  styleUrls: ['./add-agroshops.component.scss']
})
export class AddAgroshopsComponent implements OnInit {
  ...
  constructor(private storage: AngularFireStorage, private formBuilder: FormBuilder,
    public auth: AuthenticateService, private router: Router, private agroservices: AgroshopsService) {
  }
