...
@Component({
  selector: 'app-edit-agroshops',
  templateUrl: './edit-agroshops.component.html',
  styleUrls: ['./edit-agroshops.component.scss']
})
export class EditAgroshopsComponent implements OnInit {
  ...
  constructor(private storage: AngularFireStorage, private formBuilder: FormBuilder, private route: ActivatedRoute,
    public auth: AuthenticateService, private router: Router, private agro: AgroshopsService) {
  }
